...
**AICS (AI Command Script)** is an open-source, MIT-licensed format that lets you describe AI apps using simple, human-readable blocks. Think of it as _Markdown for AI apps_ — you define setup, flow, format, logic, and templates, and the AI executes it directly.

**See you in action:**
url here
NOTE: the images will not be displayed on this shared link, but if you has to run the AICS script again, images will be rendered.
